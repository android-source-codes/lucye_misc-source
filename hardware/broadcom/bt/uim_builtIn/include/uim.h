...
#define LDISC_SYSFS_BT_ERR "/sys/devices/platform/bcm_ldisc/bt_err"
#define LDISC_SYSFS_FM_ERR "/sys/devices/platform/bcm_ldisc/fm_err"
...
#define VENDOR_LIB_CONF_FILE "/product/etc/bluetooth/bt_vendor.conf"
