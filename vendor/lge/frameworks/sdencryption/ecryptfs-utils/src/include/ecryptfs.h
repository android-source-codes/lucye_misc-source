...
#endif
#if 0 // hyunk
#define LOG_TAG "SDCryptfs"
#include <android/log.h>
#define syslog(A, ...) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__)
...
#define ECRYPTFS_MAX_PASSWORD_LENGTH 64 //*3 //64
#define ECRYPTFS_MAX_PASSPHRASE_BYTES ECRYPTFS_MAX_PASSWORD_LENGTH
#define ECRYPTFS_SALT_SIZE 8
#define ECRYPTFS_SALT_SIZE_HEX (ECRYPTFS_SALT_SIZE*2)
#define ECRYPTFS_DEFAULT_SALT_HEX "1058689278209128"
...
#define ECRYPTFS_MAX_KEY_BYTES 64 //*3
#define LGE_MODIFY_SESSION_KEY_ENCRYPTION_KEY_BYTES 32
#define ECRYPTFS_MAX_ENCRYPTED_KEY_BYTES 512 //*2
