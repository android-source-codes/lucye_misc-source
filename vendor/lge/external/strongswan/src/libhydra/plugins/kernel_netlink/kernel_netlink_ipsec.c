      ...
      traffic_selector_t* src_ts, traffic_selector_t* dst_ts)
{
      ...
      case ENCR_CAMELLIA_CCM_ICV8:
         {
            ...
            DBG_WITH_ANDROID_PROPERTY("persist.net.wo.key.display", DBG_KEY, "  using encryption algorithm %N with key size %d",
   ...
   if( property_get_bool("persist.net.wo.key.dump", false)
       && property_get_bool("persist.net.wo.key.display", true) )
   {
      /* output key */
      FILE *fp;
