...
typedef enum cust_setting_type_t {
	...
	SLOT1_WIFI_DRIVER_KEEP_ALIVE,
	SLOT1_WIFI_DRIVER_KEEP_ALIVE_TIMER,
...
static cust_setting_t cust_settings[SETTING_END] = {
	...
	[SLOT1_WIFI_DRIVER_KEEP_ALIVE]            = {"net.wo.1.wdrv_keep_alive",        {.boolean = false}},
	[SLOT1_WIFI_DRIVER_KEEP_ALIVE_TIMER]      = {"net.wo.1.wdrv_keep_timer",        {.integer = -1}},
