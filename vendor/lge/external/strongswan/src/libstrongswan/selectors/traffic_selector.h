...
struct traffic_selector_t {
	...
	/**
	 * check whether any address
	 */
	bool (*has_full_range) (traffic_selector_t *this, ts_type_t cmp_type);

	/* 2017-01-02 sy.yun@lge.com LGP_DATA_IWLAN_FORCE_ANYADDR_TSR_WHILE_REKEY [START] */
	/**
	 * Set TS with any address
	 */
	bool (*set_ts_any_addr) (traffic_selector_t *this);
	/* 2017-01-02 sy.yun@lge.com LGP_DATA_IWLAN_FORCE_ANYADDR_TSR_WHILE_REKEY [END] */

	/**
	 * Set TS with single IP
	 */
	void (*set_ts_single_addr) (traffic_selector_t *this, host_t* host);

	/**
	 * Set TS_IPV6_ADDR_RANGE to be 64bits
	 */
	void (*set_ts_ipv6_range_64) (traffic_selector_t *this);
