...
METHOD(peer_cfg_t, set_imei, void, private_peer_cfg_t *this, const char *imei)
{
    this->imei = strdupnull(imei);
}

METHOD(peer_cfg_t, get_imei, char*, private_peer_cfg_t *this)
{
    return this->imei;
}

METHOD(peer_cfg_t, create_pcscf_enumerator, enumerator_t*,	private_peer_cfg_t *this)
{
...
METHOD(peer_cfg_t, create_intsubnet_enumerator, enumerator_t*, private_peer_cfg_t *this)
{
...
METHOD(peer_cfg_t, create_intnetmask_enumerator, enumerator_t*, private_peer_cfg_t *this)
{
