...
//[LG_INHOUSE_IPSEC][changhwan.lee] N-OS Compile error
//inline bool is_error_notify(notify_payload_t *notify)
...
//[LG_INHOUSE_IPSEC][changhwan.lee] N-OS Compile error
//inline bool is_status_notify(notify_payload_t *notify)
