...
2. Kernel Build  
  ...
  - Run following scripts to build kernel
   ...
   b) mkdir -p out
   d) make ARCH=arm64 O=./out CROSS_COMPILE=../../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- lucye_global_ca-perf_defconfig 
   e) make ARCH=arm64 O=./out CROSS_COMPILE=../../../prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- KCFLAGS=-mno-android -j4
